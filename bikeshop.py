...
class Bike():
    ...
    def ride(self):
        ...
        for component in components:
            if component == None:
                pass 
            elif all(component.max_lifespan *0.7 <= component.current_state <= component.max_lifespan for component in components):
    ...
    def ring_bell(self):
        ...
        for component in components:
            ...
            if component == None:
                pristine_count += 1
            elif component.check_condition() == "Pristine" :
                pristine_count += 1
        if pristine_count == 4:
            ...
            for component in [self.bell, self.brake, self.chain, self.tyres] :
                if component == None:
                    pass
                elif component.check_condition() == "Broken" :
...
class BMX(Bike):
    ...
    def run_run_tyres(self):
        if self.tyres.current_state != 0:
            self.tyres.current_state = int(self.tyres.current_state -1 -(15/100))
        if self.tyres.current_state < 0:
            self.tyres.current_state = 0

    def press_the_brakes(self):
        print("This bike does not have brakes")       
...
class Mountain(Bike):
    ...
    def ching_chain(self):
        ...
        if self.chain.current_state != 0:
            ...
            return round(self.chain.current_state,0)
        if self.chain.current_state < 0:
            self.chain.current_state = 0
...
class Service_person:
    ...
    def oil(self, bike):
        ...
        for component in components:
            if component == None:
                pass
            elif component.check_condition() == "Good":
                component.current_state = component.max_lifespan
            else : continue        
    ...
    def check_safety(self, bike):
        ...
        for component in components:
            if component == None:
                pass 
            elif all(component.check_condition() == "Fragile" or component.check_condition() == "Broken" for component in components):
